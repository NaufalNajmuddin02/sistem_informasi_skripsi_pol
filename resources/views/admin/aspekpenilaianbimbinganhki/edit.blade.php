...
<head>
    ...
    <title>Edit Penilaian Bimbingan HKI</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title mb-4">Edit Penilaian Bimbingan HKI</h3>

                        @if(session('success'))
                            <div class="alert alert-success">{{ session('success') }}</div>
                        @endif

                        <form action="{{ route('penilaian.hki.update', $aspek->id) }}" method="POST">
                            @csrf
                            @method('PUT')
