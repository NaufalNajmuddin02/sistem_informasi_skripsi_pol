...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5">
        ...
        <form method="GET" action="{{ route('rekap.bimbingan.admin') }}" class="row g-3 mb-4">
            <div class="col-md-3">
            ...
            <div class="col-md-6 d-flex align-items-end">
                ...
                <a href="{{ route('rekap.bimbingan.export.admin', ['tahun_akademik' => $tahunAkademik]) }}" class="btn btn-success">
