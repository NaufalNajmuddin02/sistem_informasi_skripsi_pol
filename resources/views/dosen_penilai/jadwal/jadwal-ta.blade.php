...
<head>
    ...
    <title>SISTA - Jadwal Tugas Akhir</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-4">
        <div class="d-flex align-items-center mb-3">
            <h1 class="me-3 mb-0">JADWAL TUGAS AKHIR</h1>
        </div>
        <hr>
        ...
        @forelse($jadwal as $item)
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <h5 class="me-2"><i class="fas fa-calendar-check text-primary"></i> Detail Yudisium</h5>
                    ...
                    <p><i class="fas fa-clock"></i> <strong>Jam:</strong> {{ $jam }}</p>
                    <p><i class="fas fa-clock"></i> <strong>Jam:</strong> {{ $selesai }}</p>
                </div>
            </div>
        @empty
            <div class="card shadow-sm mt-4">
                <div class="card-body text-center text-muted">
                    <i class="fas fa-exclamation-circle me-2"></i> Belum ada jadwal tugas akhir
                </div>
            </div>
        @endforelse
    </div>
