...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-4">
        ...
        <!-- Form Search -->
        <form method="GET" action="{{ route('dosen.seminar.penilai') }}" class="row g-2 mb-4">
            <div class="col-md-4">
                        ...
                        <div class="modal fade" id="modalNilai{{ $seminar->id }}" tabindex="-1" aria-labelledby="modalNilaiLabel{{ $seminar->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ $existing ? route('penilaian.update', $seminar->id) : route('penilaian.store', $seminar->id) }}" method="POST">
                                        @csrf
