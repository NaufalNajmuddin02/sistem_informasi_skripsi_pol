        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kaprodi.dashboard') }}">Dashboard</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{route('mapel.index')}}">Pembagian Dosen Proposal Skripsi </a></li>
                            <li><a class="dropdown-item" href="{{ route('view')}}">Manajemen Proposal Mahasiswa</a></li>
                            <li><a class="dropdown-item" href="{{route('kaprodi.semua-proposal')}}">Daftar Proposal</a></li>
                            <li><a class="dropdown-item" href="{{route('kategori.index')}}">Kategori Proposal</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('kaprodi.seminar.index') }}">Pembagian Dosen Penilai Seminar Proposal</a></li>
                            <li><a class="dropdown-item" href="{{ route('kaprodi.seminar.penilai') }}">Penilaian Seminar Proposal</a></li>
                            <li><a class="dropdown-item" href="{{route('rekap.seminar')}}">Rekap Seminar Proposal</a></li>
                            <li><a class="dropdown-item" href="{{route('kategori.index')}}">Kategori Seminar Proposal</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('kaprodi.bimbingan.index')}}">Aktifitas Bimbingan</a></li>
                            <li><a class="dropdown-item" href="{{ route('kaprodi.rekomendasi.index')}}">Surat Rekomendasi Sidang</a></li>
                            <li><a class="dropdown-item" href="{{ route('rekap.bimbingan')}}">Rekap Bimbingan Mahasiswa</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('kaprodi.jadwal.seminar') }}">Jadwal Seminar</a></li>
                            <li><a class="dropdown-item" href="{{ route('kaprodi.jadwalta') }}">Jadwal TA</a></li>
                            <li><a class="dropdown-item" href="{{ route('yudisium.index') }}">Jadwal Yudisium</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{route('kaprodi.pesertasidang')}}">Data Peserta TA</a></li>
                            <li><a class="dropdown-item" href="{{route('kaprodi.create')}}">Tambah Data Peserta TA</a></li>
                        </ul>
                    </li>
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
