...
<body class="d-flex flex-column min-vh-100">
   ...
   @if(session('success'))
    ...
    <form method="POST" action="{{ route('dosen-pembimbimg.updatepembimbing2', $mahasiswa->id) }}" id="formPembimbing1">
    @method('PUT')
    @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pelaksanaan_bimbingan_p1" value ="{{ $mahasiswa->pelaksanaan_bimbingan_p2/5 }}" class="form-control" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Daya kritis/kreativitas. <b> 10 (Bobot)</b></label>
            <input type="text" name="daya_kritis_p1" class="form-control" value ="{{ $mahasiswa->daya_kritis_p2/10 }}" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Sikap/perilaku. <b> 5 (Bobot)</b></label>
            <input type="text" name="sikap_p1" class="form-control" value ="{{ $mahasiswa->sikap_perilaku_p2/5 }}" required>
        </div>
        <h3>2. Tujuan dan Manfaat</h3>
        <div class="mb-3">
            <label class="form-label">Tujuan utama penelitian jelas<. <b> 5 (Bobot)</b></label>
            <input type="text" name="tujuan_utama_p1" class="form-control" value ="{{ $mahasiswa->tujuan_utama_p2/5 }}" required>
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="topik_penelitian_p1" class="form-control" value ="{{ $mahasiswa->topik_penelitian_p2/15 }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="latar_belakang_p1" class="form-control" value ="{{ $mahasiswa->latar_belakang_p2/5 }}" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Teori yang dijelaskan secara lengkap. <b> 5 (Bobot)</b></label>
            <input type="text" name="teori_p1" class="form-control"  value ="{{ $mahasiswa->teori_yang_dijelaskan_p2/5 }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="desain_dan_perancangan_p1" class="form-control" value ="{{ $mahasiswa->desain_dan_perancangan_p2/15 }}" required>
        </div>
        <h3>5. Hasil dan Pembahasan</h3>
        <div class="mb-3">
            <label class="form-label">Hasil sesuai dengan perancangan. <b> 5 (Bobot)</b></label>
            <input type="text" name="hasil_p1" class="form-control" value ="{{ $mahasiswa->hasil_p2/5 }}" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Pengujian dilakukan dengan metode yang tepat. <b> 5 (Bobot)</b></label>
            <input type="text" name="pengujian_p1" class="form-control" value ="{{ $mahasiswa->pengujian_p2/5 }}" required>
        </div>

        <div class="mb-3">
            <label class="form-label">Hasil penelitian ditulis dengan detail disertai pembahasan yang komprehensif. <b> 15 (Bobot)</b></label>
            <input type="text" name="hasil_penelitian_p1" class="form-control" value ="{{ $mahasiswa->hasil_penelitian_p2/15 }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kesimpulan_p1" class="form-control" value ="{{ $mahasiswa->kesimpulan_p2/5 }}" required>
        </div>
        <div class="mb-3">
            ...
            <input type="text" name="saran_penelitian_p1" class="form-control" value ="{{ $mahasiswa->saran_penelitian_p2/5 }}" required>
        </div>
