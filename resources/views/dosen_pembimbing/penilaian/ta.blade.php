...
<body>
    ...
    <form method="POST" action="{{ route('dosen-pembimbing.ketua') }}" id="formPenilai1" style="display: none;">
    ...
    <form method="POST" action="{{ route('dosen-pembimbing.penguji1') }}" id="formPenilai2" style="display: none;">
    ...
    <form method="POST" action="{{ route('dosen-pembimbing.penguji2') }}" id="formPenilai3" style="display: none;">
