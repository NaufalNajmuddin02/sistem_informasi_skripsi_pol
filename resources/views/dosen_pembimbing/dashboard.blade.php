...
<head>
    ...
    <title>SISTA Dashboard Dosen Pembimbing</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
    <link rel ="stylesheet" href="{{asset('css/dosen_pembimbing/dashboard.css')}}">
</head>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card mb-3 shadow">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-3">Jumlah Mahasiswa Bimbingan</h5>
            ...
            options: {
                ...
                scales: {
                    y: {
                        ...
                        grid: {
                            display: false, // Menghilangkan garis pada sumbu Y
                        },
                        ticks: {
                    ...
                    x: {
                        grid: {
                            display: false, // Menghilangkan garis pada sumbu X
                        }
                    }
                },
                plugins: {
