...
<body class="d-flex flex-column min-vh-100">
   ...
   @if(session('success'))
    ...
    @endif   
    <form method="POST" action="{{ route('penilaian.pembimbing2') }}" id="formPembimbing2" style="display: none;">
    ...
    <form method="POST" action="{{ route('penilaian.pembimbing1') }}" id="formPembimbing1" style="display: none;">
