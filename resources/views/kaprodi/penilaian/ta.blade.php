...
<body>
    ...
    <form method="POST" action="{{ route('penilaian.ketua') }}" id="formPenilai1" style="display: none;">
    ...
    <form method="POST" action="{{ route('penilaian.penguji1') }}" id="formPenilai2" style="display: none;">
    ...
    <form method="POST" action="{{ route('penilaian.penguji2') }}" id="formPenilai3" style="display: none;">
