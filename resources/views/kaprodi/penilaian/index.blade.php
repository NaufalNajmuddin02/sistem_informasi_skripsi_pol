        ...
        <table class="table table-striped table-bordered" id="daftar1" style="display: none;">
            ...
            @endphp
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kaprodi.penilaian.ketua.edit', $item->id) }}" class="btn btn-sm btn-warning">
            ...
            <tbody>
                @forelse($daftartabel2 as $item)
                    <tr>
                        ...
                        <td>{{ $item->total_nilai_kp }}</td>
                        <td>
                            <a href="{{ route('kaprodi.penilaian.penguji1.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                        </td>
            ...
            <tbody>
                @forelse($daftartabel3 as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kaprodi.penilaian.penguji2.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                        </td>
                    </tr>
