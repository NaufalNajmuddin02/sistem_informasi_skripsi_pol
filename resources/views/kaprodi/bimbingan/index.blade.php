    ...
    <div class="container mt-5">
        ...
        <div class="card mb-3 shadow-sm">
            <div class="card-body py-2 px-3">
                <form action="{{ route('kaprodi.bimbingan.index') }}" method="GET" class="row g-2">
                    ...
                    <div class="col-12 col-md-2">
                        <a href="{{ route('kaprodi.bimbingan.rekap') }}" class="btn btn-outline-success w-100">
                            <i class="bi bi-people-fill"></i> Rekap Bimbingan
                        </a>
                    </div>
                    <div class="col-12 col-md-2">
                        <a href="{{ route('kaprodi.rekomendasi.index') }}" class="btn btn-outline-info w-100">
                        ...
                        <div class="card h-100 shadow-sm">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between mb-2 mt-auto">
                                    ...
                                    <!-- Tambah Catatan -->
                                    <a href="{{ route('kaprodi.bimbingan.create', $seminar->id) }}" class="btn btn-primary btn-sm">
