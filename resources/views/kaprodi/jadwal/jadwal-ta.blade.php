    ...
    <div class="container my-4">
        ...
        @forelse($jadwal as $item)
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <h5 class="me-2"><i class="fas fa-calendar-alt text-primary"></i> Detail Yudisium</h5>
                    ...
                    <p><i class="fas fa-clock"></i> <strong>Jam Mulai:</strong> {{ $jam }}</p>
                    <p><i class="fas fa-clock"></i> <strong>Jam Selesai:</strong> {{ $selesai }}</p>
                </div>
            </div>
        @empty
            <div class="card shadow-sm mt-4">
                <div class="card-body text-center text-muted">
                    <i class="fas fa-exclamation-circle"></i> Belum ada jadwal yudisium
                </div>
            </div>
        @endforelse
    </div>
