    ...
    <div class="container my-5">
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('rekap.seminar') }}" class="row g-3 align-items-end">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex gap-2">
                        ...
                        <a href="{{ route('rekap.seminar.export', ['tahun_akademik' => $tahunAkademik]) }}" class="btn btn-success">
