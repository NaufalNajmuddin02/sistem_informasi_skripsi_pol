    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('proposals.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_dosen" id="nama_dosen" class="form-control" value="{{ $nama_dosen ?? '' }}" readonly>
            </div> 
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="kategori_proposal_id" id="kategori_proposal_id" class="form-control" required>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="submission_date" id="submission_date" class="form-control" value="{{ $tanggalSekarang ?? '' }}" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="link" class="form-label">Link Dokumen (Google Drive)</label>
