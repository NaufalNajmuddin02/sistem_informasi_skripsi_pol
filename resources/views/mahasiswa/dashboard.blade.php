                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-8 text-end">{{ auth()->user()->semester }}</div>
                        </div>
                        <div class="row">
                            <div class="col-4">Kelas</div>
                            <div class="col-8 text-end">{{ auth()->user()->kelas }}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-7 text-end">
                                {{ $seminar->dosen_penilai_1_nama ?? 'Belum Ditentukan' }}
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-5">Dosen pembimbing 2</div>
                            <div class="col-7 text-end">
                                {{ $seminar->dosen_penilai_2_nama ?? 'Belum Ditentukan' }}
                            </div>
                        </div>
                    </div>
                </div>
                @else
                <div class="alert alert-warning">Belum ada seminar dengan status diterima.</div>
                @endif
