...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <hr>
            <h5>Status Validasi Penguji</h5>
            <p><strong>Ketua Penguji:</strong> {{ $berkas->ketua_penguji }}</p>
            <p><strong>Status Ketua Penguji:</strong>
                <span class="badge {{ $berkas->status_ketua === 'disetujui' ? 'bg-success' : 'bg-warning text-dark' }}">
                    {{ ucfirst($berkas->status_ketua) }}
                </span>
            </p>
            <p><strong>Penguji 1:</strong> {{ $berkas->penguji1 }}</p>
            <p><strong>Status Penguji 1:</strong>
                <span class="badge {{ $berkas->status_penguji1 === 'disetujui' ? 'bg-success' : 'bg-warning text-dark' }}">
                    {{ ucfirst($berkas->status_penguji1) }}
                </span>
            </p>
            <p><strong>Penguji 2:</strong> {{ $berkas->penguji2 }}</p>
            <p><strong>Status Penguji 2:</strong>
                <span class="badge {{ $berkas->status_penguji2 === 'disetujui' ? 'bg-success' : 'bg-warning text-dark' }}">
                    {{ ucfirst($berkas->status_penguji2) }}
                </span>
            </p>
