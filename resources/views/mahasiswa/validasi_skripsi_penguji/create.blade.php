    ...
    <div class="main-content">
        <div class="container">
            <div class="form-container">
                ...
                <form action="{{ route('mahasiswa.validasi-skripsi-penguji.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $ketua }}"  name="ketua" class="form-control" readonly>
                    </div>
                     <div class="mb-3">
                        <label class="form-label">Penguji 1 :</label>
                        <input type="text" value="{{ $dosen1 }}"  name="penguji1" class="form-control" readonly>
                    </div>
                      <div class="mb-3">
                        <label class="form-label">Penguji 2 :</label>
                        <input type="text" value="{{ $dosen2 }}"  name="penguji2" class="form-control" readonly>
                    </div>
