...
class BimbinganController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dosen_pembimbing.bimbingan.index', compact('seminars', 'search'));
    }
    ...
    public function create($seminarId)
    {
        ...
        return view('dosen_pembimbing.bimbingan.create', compact('seminar', 'namaDosen'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dosen-pembimbing.bimbingan.index')->with('success', 'Catatan bimbingan berhasil ditambahkan.');
    }
    public function rekap(Request $request)
    {
        ...
        return view('dosen_pembimbing.bimbingan.rekap', compact('seminars', 'search'));
    }
