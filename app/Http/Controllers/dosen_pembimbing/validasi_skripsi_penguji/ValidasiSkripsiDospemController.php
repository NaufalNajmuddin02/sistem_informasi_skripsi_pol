...
namespace App\Http\Controllers\dosen_pembimbing\validasi_skripsi_penguji;
...
class ValidasiSkripsiDospemController extends Controller
{
    //
    ...
    // Ambil semua skripsi di mana dosen login terdaftar sebagai ketua atau penguji
        ...
        return view('dosen_pembimbing.validasi_skripsi_penguji.index', compact('skripsiList'));
    }
}
