...
namespace App\Http\Controllers\dosen_penilai\penilaian;
...
class PenilaianTugasAkhirDosenPenilaiController extends Controller
{   
    ...
    public function updatePembimbing1(Request $request, $id)
    {
        ...
        //     'sikap_kp' => 'required|numeric',
        //     'mampu_menjelaskan_topik_kp' => 'required|numeric',
        //     'mampu_menjelaskan_hasil_kp' => 'required|numeric',
        //     'simulasi_produk_kp' => 'required|numeric',
        //     'pengujian_produk_kp' => 'required|numeric',
        //     'produk_bermanfaat_kp' => 'required|numeric',
        //     'kejelasan_proses_kp' => 'required|numeric',
        //     'susunan_laporan_kp' => 'required|numeric',
        //     'isi_laporan_kp' => 'required|numeric',
        //     'kualitas_penulisan_kp' => 'required|numeric',
        //     'status_sidang_kp' => 'required|in:lolos,tidak_lolos',
        // ]);
    ...
    public function updatePenguji2(Request $request, $id)
    {
     ...
     public function indexPembimbing(){
        ...
        $daftartabel2 = PenilaianTugasAkhir::where('dosbing2_id', $user)
                    ->get();
        return view('dosen_penilai.penilaian.indexPembimbing', compact('daftartabel1','daftartabel2'));
    }
       public function editPembimbing1($id)
    {
        $mahasiswa = PenilaianTugasAkhir::findOrFail($id);
        return view('dosen_penilai.penilaian.editbimbingan1', compact('mahasiswa'));
    }
     public function editPembimbing2($id)
    {
        $mahasiswa = PenilaianTugasAkhir::findOrFail($id);
        return view('dosen_penilai.penilaian.editbimbingan2', compact('mahasiswa'));
    }
    ...
    {
        $mahasiswa = PenilaianTugasAkhir::findOrFail($id);
        return view('dosen_penilai.penilaian.editketuapenguji', compact('mahasiswa'));
    }
    public function editPenguji1($id)
    {
        $mahasiswa = PenilaianTugasAkhir::findOrFail($id);
        return view('dosen_penilai.penilaian.editpenguji1', compact('mahasiswa'));
    }
     public function editPenguji2($id)
    {
        $mahasiswa = PenilaianTugasAkhir::findOrFail($id);
        return view('dosen_penilai.penilaian.editpenguji2', compact('mahasiswa'));
    }
    public function indexPenguji(){
        ...
        $daftartabel3 = PenilaianTugasAkhir::where('penguji2_id', $user)
                    ->get();            
        return view('dosen_penilai.penilaian.index', compact('daftartabel1','daftartabel2','daftartabel3'));
    }
    public function create(){
        ...
        return view('dosen_penilai.penilaian.ta', compact('ketuaPenguji','penguji1','penguji2'));
    }
    public function createPembimbing(){
          $mahasiswa = PendaftaranSidangTA::select('id', 'nama', 'nim', 'judul_skripsi')->get();
        return view('dosen_penilai.penilaian.bimbingan', compact('mahasiswa'));
    }
