...
class ProposalKaprodiController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Pastikan hanya dosen yang dapat mengakses
        if (!$dosen->isKaprodi()) {
        ...
        return view('kaprodi.proposal.proposal', compact('proposals', 'mapels', 'search', 'tahunAkademik', 'listTahunAkademik'));
    }
    ...
    public function setDeadlinekaprodi(Request $request)
    {
        $request->validate([
    ...
    public function addCommentkaprodi(Request $request)
    {
        $request->validate([
    ...
    public function semuaProposalKaprodi(Request $request)
    {
        $tahunAkademik = $request->input('tahun_akademik');
        $search = $request->input('search');
        ...
        return view('kaprodi.proposal.semua-proposal', compact(
            'proposals',
            'tahunAkademik',
            'listTahunAkademik',
            'namaDosen',
