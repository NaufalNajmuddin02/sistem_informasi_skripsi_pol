...
namespace App\Http\Controllers\kaprodi\seminar\jadwal;
...
class JadwalSeminarKaprodiController extends Controller
{
    public function index()
    {
        ...
        return view('kaprodi.seminar.jadwal.index', compact('seminars'));
    }
}
